const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/App-Dp0Zf3hU.js","assets/gameStore-nJukt8N5.js","assets/index-Ef5Dw-qY.css"])))=>i.map(i=>d[i]);
...
async function boot() {
  const { default: App } = await __vitePreload(async () => {
    const { default: App2 } = await import("./App-Dp0Zf3hU.js").then((n2) => n2.a);
    return { default: App2 };
  }, true ? __vite__mapDeps([0,1]) : void 0);
  const { default: ErrorBoundary } = await __vitePreload(async () => {
    const { default: ErrorBoundary2 } = await import("./ErrorBoundary-CdF4ELSU.js");
    return { default: ErrorBoundary2 };
  }, true ? [] : void 0);
  const { bootSideEffects, teardownSideEffects } = await __vitePreload(async () => {
    const { bootSideEffects: bootSideEffects2, teardownSideEffects: teardownSideEffects2 } = await import("./gameStore-nJukt8N5.js").then((n2) => n2.ax);
    return { bootSideEffects: bootSideEffects2, teardownSideEffects: teardownSideEffects2 };
  }, true ? [] : void 0);
  await __vitePreload(() => Promise.resolve({}), true ? __vite__mapDeps([2]) : void 0);
  try {
    bootSideEffects();
  } catch (err) {
  ...
  root.innerHTML = `
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;background:#0a0e14;color:#ff6666;font-family:sans-serif;text-align:center;padding:2rem">
      ...
      <details style="color:#666;font-size:11px;max-width:600px">
        ...
        <pre style="text-align:left;white-space:pre-wrap;color:#ff8888;background:#111;padding:12px;border-radius:4px;margin-top:8px;max-height:200px;overflow:auto">${(err == null ? void 0 : err.stack) || (err == null ? void 0 : err.message) || String(err)}</pre>
      </details>
    </div>
  `;
});
