...
const EXOTIC_FISH = [
  { id: 'fish_uncommon_1', emoji: '🐠', label: 'Uncommon Specimen',    type: 'fish', tag: 'Exotic Fish', tagColor: 'rgba(106,176,222,0.15)', tagBorder: 'rgba(106,176,222,0.4)', tagText: '#6ab0de', desc: 'A healthy adult of uncommon lineage. Ready to sell or breed.', cost: 120, limit: 1, targetRarity: 'uncommon' },
  { id: 'fish_uncommon_2', emoji: '🐡', label: 'Unusual Catch',        type: 'fish', tag: 'Exotic Fish', tagColor: 'rgba(106,176,222,0.15)', tagBorder: 'rgba(106,176,222,0.4)', tagText: '#6ab0de', desc: 'Caught by a traveling fisherman. Uncommon traits guaranteed.',  cost: 130, limit: 1, targetRarity: 'uncommon' },
  { id: 'fish_rare_1',     emoji: '💎', label: 'Rare Import',          type: 'fish', tag: 'Rare Fish',   tagColor: 'rgba(176,126,232,0.15)', tagBorder: 'rgba(176,126,232,0.4)', tagText: '#b07ee8', desc: 'Imported from overseas. Guaranteed rare species.',             cost: 350, limit: 1, targetRarity: 'rare' },
  { id: 'fish_rare_2',     emoji: '🌊', label: 'Deep-Sea Rarity',      type: 'fish', tag: 'Rare Fish',   tagColor: 'rgba(176,126,232,0.15)', tagBorder: 'rgba(176,126,232,0.4)', tagText: '#b07ee8', desc: 'Pulled from the twilight zone. Stunning and rare.',           cost: 400, limit: 1, targetRarity: 'rare' },
  { id: 'fish_epic',       emoji: '🐉', label: 'Legendary Specimen',   type: 'fish', tag: 'Epic Fish',   tagColor: 'rgba(240,192,64,0.15)',  tagBorder: 'rgba(240,192,64,0.4)',  tagText: '#f0c040', desc: 'One of a kind. Epic rarity — the merchant\'s prized catch.', cost: 1200, limit: 1, targetRarity: 'epic', minRep: 50 },
];

// ── Supply bundles ─────────────────────────────────────────
const SUPPLY_ITEMS = [
  { id: 'bundle_medicine',      emoji: '💊', label: 'Medicine Bundle',      type: 'supplies', tag: 'Supplies', tagColor: 'rgba(100,180,220,0.2)', tagBorder: 'rgba(100,180,220,0.4)', tagText: '#6ab0de', desc: 'Antibiotic ×3, Antiparasitic ×2, Digestive Remedy ×2.',  cost: 120, limit: 2, supplies: { antibiotic: 3, antiparasitic: 2, digestiveRemedy: 2 } },
  { id: 'bundle_food',          emoji: '🍤', label: 'Premium Fish Food',    type: 'supplies', tag: 'Supplies', tagColor: 'rgba(100,180,220,0.2)', tagBorder: 'rgba(100,180,220,0.4)', tagText: '#6ab0de', desc: '+40 food supply for your active tank.',                   cost: 60,  limit: 3, supplies: { food: 40 } },
  { id: 'bundle_water',         emoji: '🧪', label: 'Water Treatment Pack', type: 'supplies', tag: 'Supplies', tagColor: 'rgba(100,180,220,0.2)', tagBorder: 'rgba(100,180,220,0.4)', tagText: '#6ab0de', desc: 'Water Treatment ×5, Antibiotic ×2.',                      cost: 90,  limit: 2, supplies: { waterTreatment: 5, antibiotic: 2 } },
  { id: 'full_restore',         emoji: '🌈', label: 'Full Restoration',     type: 'supplies', tag: 'Premium',  tagColor: 'rgba(212,168,48,0.15)',  tagBorder: 'rgba(212,168,48,0.4)',  tagText: '#d4a830', desc: 'Instantly restores water quality to 100% + food ×10.',    cost: 150, limit: 1, supplies: { food: 10 }, restoreWater: true },
  { id: 'heater_pack',          emoji: '🌡️', label: 'Heater Pack',          type: 'supplies', tag: 'Supplies', tagColor: 'rgba(100,180,220,0.2)', tagBorder: 'rgba(100,180,220,0.4)', tagText: '#6ab0de', desc: 'Heater Cartridge ×4.',                                     cost: 80,  limit: 2, supplies: { heater: 4 } },
  { id: 'breed_sprint',         emoji: '⚡', label: 'Breeding Sprint',      type: 'supplies', tag: 'Breeding', tagColor: 'rgba(160,100,240,0.15)', tagBorder: 'rgba(160,100,240,0.4)', tagText: '#b070f0', desc: 'Breeding Boost ×3. Cuts breeding cycles to 10 seconds.',  cost: 140, limit: 1, supplies: { breedingBoost: 3 } },
  { id: 'bundle_antiparasitic', emoji: '🔬', label: 'Antiparasitic Bundle', type: 'supplies', tag: 'Supplies', tagColor: 'rgba(100,180,220,0.2)', tagBorder: 'rgba(100,180,220,0.4)', tagText: '#6ab0de', desc: 'Antiparasitic ×4, Digestive Remedy ×3.',                   cost: 130, limit: 2, supplies: { antiparasitic: 4, digestiveRemedy: 3 } },
];

// ── Boosters ───────────────────────────────────────────────
const BOOSTER_ITEMS = [
  { id: 'boost_grow',   emoji: '🌱', label: 'Growth Formula',  type: 'booster', tag: 'Boost', tagColor: 'rgba(80,200,80,0.12)', tagBorder: 'rgba(80,200,80,0.35)', tagText: '#60c860', desc: 'All fish grow 50% faster for 10 minutes.',       cost: 200, limit: 1, boost: 'growSpeed',     boostDurationMs: 600_000 },
  { id: 'boost_health', emoji: '💖', label: 'Vitality Tonic',  type: 'booster', tag: 'Boost', tagColor: 'rgba(80,200,80,0.12)', tagBorder: 'rgba(80,200,80,0.35)', tagText: '#60c860', desc: 'Health regenerates 3× faster for 10 minutes.',    cost: 175, limit: 1, boost: 'healthRegen',   boostDurationMs: 600_000 },
  { id: 'boost_price',  emoji: '📈', label: 'Market Frenzy',   type: 'booster', tag: 'Boost', tagColor: 'rgba(80,200,80,0.12)', tagBorder: 'rgba(80,200,80,0.35)', tagText: '#60c860', desc: 'Customers pay 25% more for 10 minutes.',          cost: 250, limit: 1, boost: 'salePrice',     boostDurationMs: 600_000 },
  { id: 'boost_income', emoji: '🌊', label: 'High Tide',       type: 'booster', tag: 'Boost', tagColor: 'rgba(80,200,80,0.12)', tagBorder: 'rgba(80,200,80,0.35)', tagText: '#60c860', desc: 'Passive coin income doubles for 10 minutes.',     cost: 180, limit: 1, boost: 'passiveIncome', boostDurationMs: 600_000 },
];
...
const RARITY_COLORS = {
  common: '#7ec8a0', uncommon: '#6ab0de', rare: '#b07ee8', epic: '#f0c040', legendary: '#ff7eb3',
};
