...
export const REAL_SPECIES = [
  ...
  {
    key: 'axolotl', name: 'Axolotl', scientificName: 'Ambystoma mexicanum',
    rarity: 'rare', visualType: 'species', basePrice: 350,
    ...
    habitat: 'Lake Xochimilco, Mexico City', funFact: 'Axolotls can regenerate limbs, heart tissue, and even parts of their brain.',
    conservationStatus: 'Critically Endangered',
    behaviorProfile: { swimSpeed: 0.15, turnChance: 0.015, bobAmplitude: 0.006, preferredYRange: [70, 95], idleProbability: 0.6, dartiness: 0.05 },
  },
  {
    key: 'yellow_tang', name: 'Yellow Tang', scientificName: 'Zebrasoma flavescens',
    rarity: 'uncommon', visualType: 'species', basePrice: 280,
    ...
    habitat: 'Hawaiian reefs, 2-46m', funFact: 'Yellow tangs have a retractable scalpel-like spine near their tail that they use for defense.',
    conservationStatus: 'Least Concern',
  ...
  {
    key: 'arowana', name: 'Asian Arowana', scientificName: 'Scleropages formosus',
    rarity: 'epic', visualType: 'species', basePrice: 2000,
    ...
    habitat: 'Southeast Asian rivers and swamps', funFact: 'Arowanas are mouthbrooders — males carry eggs in their mouths for weeks until they hatch.',
    conservationStatus: 'Endangered',
    behaviorProfile: { swimSpeed: 0.35, turnChance: 0.01, bobAmplitude: 0.008, preferredYRange: [15, 40], idleProbability: 0.35, dartiness: 0.15 },
  },
  {
    key: 'cherry_shrimp', name: 'Cherry Shrimp', scientificName: 'Neocaridina davidi',
    rarity: 'common', visualType: 'species', basePrice: 30,
    ...
    habitat: 'Taiwanese freshwater streams', funFact: 'A single female can carry 20-30 eggs at a time, and they breed prolifically in captivity.',
    conservationStatus: 'Least Concern',
    behaviorProfile: { swimSpeed: 0.1, turnChance: 0.04, bobAmplitude: 0.003, preferredYRange: [80, 98], idleProbability: 0.7, dartiness: 0.02 },
  },
  {
    key: 'oscar', name: 'Oscar', scientificName: 'Astronotus ocellatus',
    rarity: 'uncommon', visualType: 'species', basePrice: 180,
    ...
    habitat: 'Amazon basin, slow-moving rivers', funFact: 'Oscars rearrange their tank decorations to suit their preferences. They are interior decorators.',
    conservationStatus: 'Least Concern',
    behaviorProfile: { swimSpeed: 0.3, turnChance: 0.02, bobAmplitude: 0.01, preferredYRange: [30, 70], idleProbability: 0.3, dartiness: 0.2 },
  },
  {
    key: 'guppy', name: 'Guppy', scientificName: 'Poecilia reticulata',
    rarity: 'common', visualType: 'species', basePrice: 25,
    ...
    habitat: 'Caribbean streams and ponds', funFact: 'Female guppies can store sperm for months, producing multiple batches of fry from a single mating.',
    conservationStatus: 'Least Concern',
    behaviorProfile: { swimSpeed: 0.55, turnChance: 0.05, bobAmplitude: 0.02, preferredYRange: [20, 70], idleProbability: 0.1, dartiness: 0.5 },
  },
  {
    key: 'cuttlefish', name: 'Cuttlefish', scientificName: 'Sepia officinalis',
    rarity: 'rare', visualType: 'species', basePrice: 650,
    colorVariants: ['default'],
    ...
    habitat: 'Mediterranean and North Sea, shallow waters', funFact: 'Cuttlefish have one of the largest brain-to-body ratios of any invertebrate and can count.',
    conservationStatus: 'Least Concern',
    behaviorProfile: { swimSpeed: 0.2, turnChance: 0.02, bobAmplitude: 0.005, preferredYRange: [40, 80], idleProbability: 0.45, dartiness: 0.08 },
  },
  {
    key: 'corydoras', name: 'Corydoras', scientificName: 'Corydoras paleatus',
    rarity: 'common', visualType: 'species', basePrice: 40,
    ...
    habitat: 'South American rivers, sandy bottoms', funFact: 'Corydoras breathe air by gulping at the surface, making an adorable squeaking sound.',
    conservationStatus: 'Least Concern',
    behaviorProfile: { swimSpeed: 0.2, turnChance: 0.04, bobAmplitude: 0.004, preferredYRange: [85, 98], idleProbability: 0.5, dartiness: 0.1 },
  },
  {
    key: 'hammerhead', name: 'Hammerhead Shark', scientificName: 'Sphyrna lewini',
    rarity: 'epic', visualType: 'species', basePrice: 1500,
    colorVariants: ['default'],
    lore: 'The hammer-shaped head gives 360-degree binocular vision. A prestige predator that commands respect in any aquarium.',
    habitat: 'Tropical oceans worldwide, 0-275m', funFact: 'Hammerheads use their wide heads as metal detectors, sensing the electrical fields of buried prey.',
    conservationStatus: 'Critically Endangered',
    behaviorProfile: { swimSpeed: 0.6, turnChance: 0.015, bobAmplitude: 0.008, preferredYRange: [15, 50], idleProbability: 0.1, dartiness: 0.25 },
  },
  {
    key: 'nautilus', name: 'Nautilus', scientificName: 'Nautilus pompilius',
    rarity: 'rare', visualType: 'species', basePrice: 500,
    colorVariants: ['default'],
    ...
    habitat: 'Indo-Pacific deep reefs, 100-700m', funFact: 'Nautiluses have up to 90 tentacles but no suckers. They rely on a sticky mucus to grip prey.',
  ...
  { key: 'rainbow_fish', name: 'Rainbow Fish', scientificName: 'Melanotaenia boesemani',
    rarity: 'uncommon', visualType: 'procedural', basePrice: 180,
  ...
  { key: 'pleco', name: 'Plecostomus', scientificName: 'Hypostomus plecostomus',
    rarity: 'common', visualType: 'procedural', basePrice: 60,
    lore: 'The armored algae-eater that keeps your glass clean.',
    habitat: 'South American rivers',
    behaviorProfile: { swimSpeed: 0.1, turnChance: 0.02, bobAmplitude: 0.003, preferredYRange: [85, 98], idleProbability: 0.65, dartiness: 0.05 },
  },
  { key: 'clown_loach', name: 'Clown Loach', scientificName: 'Chromobotia macracanthus',
    rarity: 'uncommon', visualType: 'procedural', basePrice: 160,
    lore: 'Bright orange with bold black bands. Plays dead when startled.',
    habitat: 'Borneo and Sumatra rivers',
    behaviorProfile: { swimSpeed: 0.35, turnChance: 0.05, bobAmplitude: 0.008, preferredYRange: [70, 95], idleProbability: 0.35, dartiness: 0.2 },
  },
  { key: 'flame_tetra', name: 'Flame Tetra', scientificName: 'Hyphessobrycon flammeus',
    rarity: 'common', visualType: 'procedural', basePrice: 40,
  ...
  { key: 'powder_blue_tang', name: 'Powder Blue Tang', scientificName: 'Acanthurus leucosternon',
    rarity: 'rare', visualType: 'procedural', basePrice: 450,
  ...
  { key: 'firemouth_cichlid', name: 'Firemouth Cichlid', scientificName: 'Thorichthys meeki',
    rarity: 'uncommon', visualType: 'procedural', basePrice: 140,
    lore: 'Flares its bright red gill plates as a threat display.',
    habitat: 'Central American rivers',
    behaviorProfile: { swimSpeed: 0.3, turnChance: 0.04, bobAmplitude: 0.006, preferredYRange: [50, 80], idleProbability: 0.35, dartiness: 0.15 },
  },
  { key: 'harlequin_rasbora', name: 'Harlequin Rasbora', scientificName: 'Trigonostigma heteromorpha',
    rarity: 'common', visualType: 'procedural', basePrice: 35,
  ...
  { key: 'royal_gramma', name: 'Royal Gramma', scientificName: 'Gramma loreto',
    rarity: 'rare', visualType: 'procedural', basePrice: 380,
    lore: 'Half purple, half gold — nature split the color palette in two.',
    habitat: 'Caribbean reef caves',
    behaviorProfile: { swimSpeed: 0.3, turnChance: 0.04, bobAmplitude: 0.008, preferredYRange: [55, 85], idleProbability: 0.4, dartiness: 0.1 },
  },
  { key: 'cardinal_tetra', name: 'Cardinal Tetra', scientificName: 'Paracheirodon axelrodi',
    rarity: 'common', visualType: 'procedural', basePrice: 45,
  ...
  { key: 'dwarf_gourami', name: 'Dwarf Gourami', scientificName: 'Trichogaster lalius',
    rarity: 'uncommon', visualType: 'procedural', basePrice: 130,
    lore: 'Bright blue and red striped labyrinth fish that breathes air.',
    habitat: 'Indian slow-flowing waters',
    behaviorProfile: { swimSpeed: 0.2, turnChance: 0.03, bobAmplitude: 0.008, preferredYRange: [15, 45], idleProbability: 0.45, dartiness: 0.08 },
  },
  { key: 'banggai_cardinal', name: 'Banggai Cardinalfish', scientificName: 'Pterapogon kauderni',
    rarity: 'rare', visualType: 'procedural', basePrice: 350,
    lore: 'Silver with bold black bars. Males mouth-brood the eggs.',
    habitat: 'Banggai Islands, Indonesia',
    behaviorProfile: { swimSpeed: 0.2, turnChance: 0.03, bobAmplitude: 0.006, preferredYRange: [40, 70], idleProbability: 0.5, dartiness: 0.05 },
  },
  { key: 'leopard_wrasse', name: 'Leopard Wrasse', scientificName: 'Macropharyngodon meleagris',
    rarity: 'rare', visualType: 'procedural', basePrice: 420,
  ...
  { key: 'garden_eel', name: 'Garden Eel', scientificName: 'Heteroconger hassi',
    rarity: 'uncommon', visualType: 'procedural', basePrice: 200,
  ...
  { key: 'flame_angel', name: 'Flame Angelfish', scientificName: 'Centropyge loricula',
    rarity: 'rare', visualType: 'procedural', basePrice: 500,
    lore: 'Brilliant red-orange with vertical black bars and blue-tipped fins.',
    habitat: 'Pacific Ocean reefs',
    behaviorProfile: { swimSpeed: 0.35, turnChance: 0.04, bobAmplitude: 0.009, preferredYRange: [35, 65], idleProbability: 0.3, dartiness: 0.12 },
  },
  { key: 'emerald_crab', name: 'Emerald Crab', scientificName: 'Mithraculus sculptus',
    rarity: 'common', visualType: 'procedural', basePrice: 55,
    lore: 'A tiny green crab that devours bubble algae. The cleanup crew MVP.',
    habitat: 'Caribbean reefs',
    behaviorProfile: { swimSpeed: 0.08, turnChance: 0.02, bobAmplitude: 0.002, preferredYRange: [90, 99], idleProbability: 0.6, dartiness: 0.05 },
  },
  { key: 'regal_tang', name: 'Regal Tang', scientificName: 'Paracanthurus hepatus',
    rarity: 'rare', visualType: 'procedural', basePrice: 400,
  ...
  { key: 'peacock_mantis', name: 'Peacock Mantis Shrimp', scientificName: 'Odontodactylus scyllarus',
    rarity: 'epic', visualType: 'procedural', basePrice: 800,
    lore: 'Punches prey at the speed of a bullet. Sees 16 color channels.',
    habitat: 'Indo-Pacific shallow reefs',
    behaviorProfile: { swimSpeed: 0.15, turnChance: 0.03, bobAmplitude: 0.005, preferredYRange: [75, 95], idleProbability: 0.5, dartiness: 0.35 },
  },
  { key: 'blue_chromis', name: 'Blue Chromis', scientificName: 'Chromis cyanea',
    rarity: 'common', visualType: 'procedural', basePrice: 50,
  ...
  { key: 'dragon_goby', name: 'Dragon Goby', scientificName: 'Gobioides broussonnetii',
    rarity: 'uncommon', visualType: 'procedural', basePrice: 170,
    lore: 'A prehistoric-looking eel-shaped goby with tiny fangs.',
    habitat: 'Atlantic brackish estuaries',
    behaviorProfile: { swimSpeed: 0.15, turnChance: 0.02, bobAmplitude: 0.004, preferredYRange: [80, 98], idleProbability: 0.55, dartiness: 0.1 },
  },
  { key: 'spotted_boxfish', name: 'Spotted Boxfish', scientificName: 'Ostracion meleagris',
    rarity: 'uncommon', visualType: 'procedural', basePrice: 220,
    lore: 'A boxy body covered in white polka dots. Surprisingly fast when alarmed.',
    habitat: 'Indo-Pacific reefs',
    behaviorProfile: { swimSpeed: 0.25, turnChance: 0.04, bobAmplitude: 0.006, preferredYRange: [40, 75], idleProbability: 0.4, dartiness: 0.2 },
  },
  { key: 'sea_apple', name: 'Sea Apple', scientificName: 'Pseudocolochirus violaceus',
    rarity: 'rare', visualType: 'procedural', basePrice: 350,
    lore: 'A vivid purple sea cucumber that filter-feeds with feathery tentacles.',
    habitat: 'Indo-Pacific reefs',
    behaviorProfile: { swimSpeed: 0.03, turnChance: 0.01, bobAmplitude: 0.002, preferredYRange: [85, 99], idleProbability: 0.8, dartiness: 0.02 },
  },
  { key: 'wolf_eel', name: 'Wolf Eel', scientificName: 'Anarrhichthys ocellatus',
    rarity: 'epic', visualType: 'procedural', basePrice: 900,
    lore: 'A fierce-looking fish that mates for life. Not actually an eel.',
    habitat: 'North Pacific rocky reefs',
    behaviorProfile: { swimSpeed: 0.2, turnChance: 0.02, bobAmplitude: 0.005, preferredYRange: [60, 90], idleProbability: 0.5, dartiness: 0.1 },
  },
  { key: 'sunburst_anthias', name: 'Sunburst Anthias', scientificName: 'Serranocirrhitus latus',
    rarity: 'epic', visualType: 'procedural', basePrice: 1200,
  ...
  { key: 'frogfish', name: 'Frogfish', scientificName: 'Antennarius commerson',
    rarity: 'epic', visualType: 'procedural', basePrice: 700,
    lore: 'A master of disguise that lures prey with a built-in fishing rod.',
    habitat: 'Tropical reefs worldwide',
    behaviorProfile: { swimSpeed: 0.05, turnChance: 0.01, bobAmplitude: 0.003, preferredYRange: [75, 95], idleProbability: 0.75, dartiness: 0.4 },
  },
];
